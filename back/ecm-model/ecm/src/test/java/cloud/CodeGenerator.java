...
public class CodeGenerator {
    ...
    private static final String author = "yzy";//作者


    private static final String url = "jdbc:mysql://172.1.4.213:3306/dev_ecm?useUnicode=true&characterEncoding=UTF-8";//数据库
    ...
    private static final String projectName = "ecm";//项目名称
    private static final String packageName = "com.sunyard.ecm";//包名
