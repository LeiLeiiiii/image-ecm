...
@RestController
@RequestMapping("pc/capture/button")
public class PcCaptureButtonController extends BaseController {
    ...
    public Result getFileLabelHistory(@RequestBody EcmFileTagOperationHistoryDTO dto) {
        List<EcmFileTagOperationHistory> historyList = fileTagOperationHistoryService
                .getFileLabelHistory(dto);
