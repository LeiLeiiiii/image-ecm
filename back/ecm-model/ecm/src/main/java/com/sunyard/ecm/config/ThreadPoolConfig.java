...
public class ThreadPoolConfig {
     ...
     * 业务日志线程池
     */
    public static final String BUSI_LOG_TASK_EXECUTOR = "BusiLogThreadPool";

    /**
     * 初始化线程池参数
     * @return
     */
    @Bean(BUSI_LOG_TASK_EXECUTOR)
    public TaskExecutor taskExecutor() {
        String threadName = "BusiLog-Thread-Pool";
        log.info("开始初始化线程池:{}", threadName);
        ThreadPoolTaskExecutor taskExecutor = new ThreadPoolTaskExecutor();
