package com.sunyard.ecm.controller.mobile;
...
public class MobileCaptureController extends BaseController {
    ...
    public Result getBusinessList(@RequestBody EcmMobileBusiListDTO ecmMobileCaptureBusiDTO) {
        List<EcmBusiInfoPhoneDTO> busiInfoPhoneDTOS = mobileCaptureService
                .getMobileBusiList(ecmMobileCaptureBusiDTO);
    ...
    public Result getBusinessListAll(@RequestBody EcmMobileBusiListDTO ecmMobileCaptureBusiDTO) {
        List<EcmBusiInfoPhoneDTO> busiInfoPhoneDTOS = mobileCaptureService
                .getBusinessListAll(ecmMobileCaptureBusiDTO, getToken());
        return Result.success(busiInfoPhoneDTOS);
    }
    ...
    public Result getBusiListByBusiNo(@RequestBody EcmMobileCaptureBusiDTO ecmMobileCaptureBusiDTO) {
        List<EcmBusiInfoPhoneDTO> busiInfoPhoneDTOS = mobileCaptureService
                .getBusinessList(ecmMobileCaptureBusiDTO);
        return Result.success(busiInfoPhoneDTOS);
    }
    ...
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "获取最子级节点资料列表")
    @PostMapping("getInformation")
    public Result getInformation(@RequestBody EcmMobileCaptureDocDTO ecmMobileCaptureDocDTO) {
        List<EcmBusiStructureTreeDTO> information = mobileCaptureService.getInformation(
                getToken(), ecmMobileCaptureDocDTO.getBusiId(),
                ecmMobileCaptureDocDTO.getInfoTypeName());
    ...
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "获取资料文件列表")
    @PostMapping("getDocFileList")
    public Result getDocFileList(@RequestBody EcmMobileCaptureFileDTO ecmMobileCaptureFileDTO) {
        PageInfo docFileList = mobileCaptureService.getDocFileList(
                ecmMobileCaptureFileDTO.getBusiId(), ecmMobileCaptureFileDTO.getDocId(),
                ecmMobileCaptureFileDTO.getShowAll(), ecmMobileCaptureFileDTO.getMarkDocId(),
                getToken());
     ...
     */
    @ApiOperation("新增文件信息")
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "新增文件信息")
    @PostMapping("insertFileInfo")
    public Result insertFileInfo(@RequestBody EcmFileInfoDTO ecmFileInfoDTO) {
        ecmFileInfoDTO.setFileSource(IcmsConstants.FILE_SOURCE_MOBILE);
     ...
     * 图片编辑后插入文件信息
     */
    @ApiOperation("旋转文件后插入文件信息")
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "旋转文件前后插入文件信息")
     ...
     */
    @ApiOperation("影像删除")
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "影像删除")
    ...
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "已删除列表中影像删除")
     ...
     */
    @ApiOperation("文件移动")
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "文件移动")
     ...
     */
    @ApiOperation("影像提交")
    @OperationLog(LogsConstants.MOBILE_CAPTURE + "影像提交")
    @PostMapping("submit")
     ...
     */
    @ApiOperation("查询资料标记")
    @OperationLog(LogsConstants.CAPTURE + "查询资料标记")
    ...
    public Result getRightButtonList() {
        List<HashMap<String, String>> rightButtonList = mobileCaptureService
                .getRightButtonList(getToken().getId(), RoleConstants.IMAGE_CAPTURE);
    ...
    public Result getDeletedButtonList() {
        List<HashMap<String, String>> rightButtonList = mobileCaptureService
                .getDeletedButtonList(getToken().getId(), RoleConstants.CAPTURE_VIEW_DELETED);
        return Result.success(rightButtonList);
    }
