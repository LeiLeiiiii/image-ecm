package com.sunyard.ecm.oldToNew.constant;
...
public class ApiConstants {
     ...
     */
    public static final String NAME = "ecm-server";
...
//    public static final String storageUri = "";
    ...
    //调阅、扫描
    public static final String ACCESSECM = BASEURI + ECMURI +"/api/ecms/operate/capture/scanOrUpdateEcm";

    //移动端调阅、扫描
    public static final String ACCESSECM_MOBILE = BASEURI + ECMURI +"/api/ecms/mobile/capture/scanOrUpdateEcmMobile";

    //复制
    public static final String BUSIDOCDUPLICATE = BASEURI + ECMURI +"/api/ecms/operate/copy/busiDocDuplicate";

    //资源获取
    public static final String QUERYECM = BASEURI + ECMURI +"/api/ecms/operate/query/queryEcm";

    //删除
    public static final String DELETEFILE = BASEURI + ECMURI +"/api/ecms/operate/delete/deleteFileByBusiOrDoc";

    //上传-校验文件格式和md5
    public static final String CHECKFILE = BASEURI + ECMURI +"/api/ecms/operate/upload/checkFile";
    ...
    public static final String INSERTFILEINFO = BASEURI + ECMURI +"/api/ecms/operate/capture/insertFileInfo";

    //关联业务-将文件信息存入影像系统（后端接口）
//    public static final String INSERTFILEINFOBACK = BASEURI + ECMURI +"/api/ecms/operate/upload/insertFileInfoBack";
    public static final String INSERTFILEINFOBACK = BASEURI + ECMURI +"/api/ecms/operate/upload/insertFileListInfo";

    //根据业务 + 资料节点，查询文件信息(文件下载)
    public static final String FILELIST = BASEURI + ECMURI +"/api/ecms/operate/download/getFileInfoByBusiOrDoc";

    //获取业务类型信息（业务类型压缩信息）
    public static final String APPTYPEINFO = BASEURI + ECMURI +"/api/ecms/operate/upload/getAppTypeInfo";

    //业务属性回写列表
    public static final String ATTRLIST = BASEURI + ECMURI +"/api/ecms/operate/attributes/setBusiAttr";

    //批扫页面跳转
    public static final String BATCHSCAN = BASEURI + ECMURI +"/api/ecms/operate/capture/batchScan";

    //单扫页面跳转
    public static final String SINGLSCAN = BASEURI + ECMURI +"/api/ecms/operate/capture/signalScan";
