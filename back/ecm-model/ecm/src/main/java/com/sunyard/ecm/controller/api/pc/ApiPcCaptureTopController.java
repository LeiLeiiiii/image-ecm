...
@RestController
@RequestMapping("api/pc/capture/top")
public class ApiPcCaptureTopController extends BaseController {
    ...
    public Result insertFileInfo(@RequestBody EcmFileInfoDTO ecmFileInfoDTO) {
        ecmFileInfoDTO.setFileSource(IcmsConstants.FILE_SOURCE_API_PC);
