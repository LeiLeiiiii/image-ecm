...
@RestController
@RequestMapping("api/pc/capture/left")
public class ApiPcCaptureLeftController extends BaseController {
    ...
    public Result getAppTypeTreeFilterRightRead(String appCode) {
        return Result.success(modelBusiService.searchBusiTypeTree(appCode,getToken(),true,"read"));
    }
    ...
    public Result getBusiStructureTree(@RequestBody EcmStructureTreeDTO ecmStructureTreeDTO) {
        ...
        return Result.success(operateCaptureService.getBusiStructureTree(getToken().getUsername(),ecmStructureTreeDTO,getToken()));
    }
    ...
    public Result getAppAttrList(@RequestBody EcmBusiInfoRedisDTO ecmBusiInfoExtend) {
        return Result.success(operateCaptureService.getAppAttrList(ecmBusiInfoExtend.getAppCode(),ecmBusiInfoExtend.getBusiId(), null));
    }
