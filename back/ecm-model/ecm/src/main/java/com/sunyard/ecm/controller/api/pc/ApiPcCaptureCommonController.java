...
@RestController
@RequestMapping("api/pc/capture/common")
public class ApiPcCaptureCommonController extends BaseController {
    ...
    public Result getRightButtonList() {
        return menuApi.getRightButtonListByRoles(getToken().getRoleCodeList(),
    ...
    public Result getRightButtonListQuery() {
        return menuApi.getRightButtonListByRoles(getToken().getRoleCodeList(), RoleConstants.IMAGE_VIEW);
    }
