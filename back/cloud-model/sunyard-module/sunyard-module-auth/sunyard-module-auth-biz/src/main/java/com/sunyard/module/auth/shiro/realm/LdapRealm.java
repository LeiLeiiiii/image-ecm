...
public class LdapRealm extends AuthorizingRealm {
    ...
    public AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken)
        ...
        List<SysUserDTO> list =
            authUserApi.ldapLogin(loginToken.getUsername(), new String(loginToken.getPassword())).getData();
        ...
        SimpleAuthenticationInfo authcInfo =
            new SimpleAuthenticationInfo(loginToken, loginToken.getPassword(), getName());
