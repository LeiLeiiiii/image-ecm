...
/**
 * @Type ShiroCache.java
 * @Desc
 * @author zhouleibin-bwf
 * @date 2018年9月28日 下午2:17:29
 * @version
 */
public class ShiroCache<K, V> implements Cache<K, V> {
    ...
    public ShiroCache(String name, RedisTemplate client, Long expire) {
        this.cacheKey = name + ":";
        this.redisTemplate = client;
        this.globExpire = expire == null ? globExpire : expire;
    }
