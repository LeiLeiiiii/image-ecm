...
@Order(2)
@Component
public class ConsoleControllerAspect extends BaseAspect {
    private static final ThreadLocal<Long> BEGIN_TIME_THREAD_LOCAL =
        new NamedThreadLocal<>("Controller ThreadLocal beginTime");

    /**
     * controller中Post\Get日志
     */
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        super.inputConsoleLogs(point, LogConstants.STOREY_CONTROLLER, param);
        Object result = point.proceed();

        long elapsedTimeInMillis = (System.nanoTime() - BEGIN_TIME_THREAD_LOCAL.get()) / 1000000;

        super.outputConsoleLogs(point, LogConstants.STOREY_CONTROLLER, null, elapsedTimeInMillis);
