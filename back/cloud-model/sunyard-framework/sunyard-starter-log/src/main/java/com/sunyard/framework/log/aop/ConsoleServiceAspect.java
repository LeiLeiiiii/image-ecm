...
@Order(3)
@Component
public class ConsoleServiceAspect extends BaseAspect {
    private static final ThreadLocal<Long> BEGIN_TIME_THREAD_LOCAL =
        new NamedThreadLocal<>("Service ThreadLocal beginTime");
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        super.inputConsoleLogs(point, LogConstants.STOREY_SERVICE, null);
        Object result = point.proceed();

        long elapsedTimeInMillis = (System.nanoTime() - BEGIN_TIME_THREAD_LOCAL.get()) / 1000000;
        super.outputConsoleLogs(point, LogConstants.STOREY_SERVICE, null, elapsedTimeInMillis);
        return result;
    }
