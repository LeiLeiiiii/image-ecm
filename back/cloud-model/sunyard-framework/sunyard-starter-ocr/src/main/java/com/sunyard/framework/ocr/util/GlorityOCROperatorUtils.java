 ...
 */
@Slf4j
public class GlorityOCROperatorUtils {
    @Resource
    private GlorityOcrProperties glorityOcrProperties;
    @Resource(name="GlorityOCRRestTemplate")
     ...
     * 
     * @param invoiceValidation 解析验证参数
     */
     ...
     * 
     * @param ocrResultDTO ocrResultDTO
     * @return ValidateRequestParamDTO
     */
    public ValidateRequestParamDTO buildValidateRequestParamByOcrResult(OcrResultDTO ocrResultDTO) {
        ...
        log.debug("验真参数：checkCode:{},code:{},date:{},number:{},type:{},pretaxAmount:{}", checkCode, code, date, number,
            type, pretaxAmount);
