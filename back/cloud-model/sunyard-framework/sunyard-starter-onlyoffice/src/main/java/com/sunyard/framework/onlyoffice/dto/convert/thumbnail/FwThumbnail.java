package com.sunyard.framework.onlyoffice.dto.convert.thumbnail;
...
public class FwThumbnail {
     ...
     * 默认值为2。
     */
    @Value("${onlyoffice.convert.thumbnail.aspect:2}")
     ...
     * 默认值为true，
     */
    @Value("${onlyoffice.convert.thumbnail.first:true}")
    private Boolean first;
    /**
     * 定义缩略图高度（以像素为单位）。 默认值为100。
     */
    @Value("${onlyoffice.convert.thumbnail.height:100}")
    private Integer height;
    /**
     * 定义缩略图宽度（以像素为单位）。 默认值为100。
     */
    @Value("${onlyoffice.convert.thumbnail.width:100}")
