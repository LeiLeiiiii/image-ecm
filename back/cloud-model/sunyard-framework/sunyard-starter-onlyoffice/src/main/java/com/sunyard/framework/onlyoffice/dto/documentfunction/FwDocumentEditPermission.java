...
@Configuration
@Data
public class FwDocumentEditPermission {
    /**
     ...
     * 默认为true
     */
    @Value("${onlyoffice.document.permissions.edit.comment:true}")
     ...
     * 是否允许下载 默认为true
     */
    @Value("${onlyoffice.document.permissions.edit.download:true}")
     ...
     */
    @Value("${onlyoffice.document.permissions.edit.editCommentAuthorOnly:true}")
     ...
     * 仅表单填写模式目前仅适用于文档编辑器。
     */
    @Value("${onlyoffice.document.permissions.edit.fillForms:true}")
    private Boolean fillForms;
    /**
     * 定义是否可以更改内容控件设置。 仅当mode参数设置为编辑时，内容控件修改才可用于文档编辑器。 默认值为true。
     */
    @Value("${onlyoffice.document.permissions.edit.modifyContentControl:true}")
     ...
     */
    @Value("${onlyoffice.document.permissions.edit.modifyFilter:true}")
    private Boolean modifyFilter;
    /**
     * 定义文档是否可以打印。 如果打印权限设置为“false”打印菜单选项将不在“文件”菜单中。 默认值为true。
     */
    @Value("${onlyoffice.document.permissions.edit.print:true}")
    private Boolean print;
    /**
     * 定义是显示工具栏上的“保护”选项卡和左侧菜单中的“保护”按钮（真）还是隐藏（假）。 默认值为true。
     */
    @Value("${onlyoffice.document.permissions.edit.protect:true}")
     ...
     * 默认：true
     */
    @Value("${onlyoffice.document.permissions.edit.review:true}")
